...
import animationData from "../assets/lottie/title.json";
...
const Intro = () => {
  ...
  return (
    <div className="border-bottom">
      <div className="main-image-wrap" style={{ position: "relative" }}>
        <img
